  ...
  for (ptr = buf; ptr < buf + ifc.ifc_len; ) {
    ...
    *ifipnext = ifi;			/* prev points to this new one */
	...
	memcpy(ifi->ifi_dstaddr, sinptr, sizeof(struct sockaddr_in));
      ...
      /*!!!!!!!!!!!!!!!!!!!!!!!Calculate network id ADDED my RM!!!!!!!!!!!!!!!!!!!!!!!!!!!!!*/
      ifi->ifi_netid = Calloc(1, sizeof(struct sockaddr_in));
      memcpy(ifi->ifi_netid, sinptr, sizeof(struct sockaddr_in));
      ((struct sockaddr_in *)ifi->ifi_netid)->sin_addr.s_addr = ((struct sockaddr_in *)ifi->ifi_addr)->sin_addr.s_addr & ((struct sockaddr_in *)ifi->ifi_ntmaddr)->sin_addr.s_addr;
#endif
